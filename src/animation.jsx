...
mtlLoader.setResourcePath('/src/Components/Drone_Costum/Material/');
mtlLoader.setPath('/src/Components/Drone_Costum/Material/');
mtlLoader.load('drone_costum.mtl', function (materials) {
  materials.preload();
  const objLoader = new OBJLoader();
  objLoader.setMaterials(materials);
  objLoader.setPath('/src/Components/Drone_Costum/Material/');
  ...
  if (responsiveConfig.isStacked) {
    ...
    const createLine = (str, y) => {
      ...
      const mat = new THREE.MeshBasicMaterial({
        color: 0x00ffff, // Cyan blue to match animation theme
        transparent: true,
        opacity: 0
      });
        ...
        if (responsiveConfig.isStacked) {
          ...
          const createLine = (str, y) => {
            ...
            const mat = new THREE.MeshStandardMaterial({
              color: 0x00ffff, // Cyan blue to match animation theme
              emissive: 0x002244, // Subtle cyan glow
          ...
          const textMaterial = new THREE.MeshStandardMaterial({
            color: 0xffffff, // White for better contrast
