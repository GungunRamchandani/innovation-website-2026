...
const Timeline2 = () => {
  ...
  const verticalLocs = [
    ...
    { id: 13, x: 35, y: 52,  title: "EVENT M", venue: "IT Building" },
    { id: 14, x: 39, y: 43,  title: "EVENT N", venue: "IT Building" },
    { id: 15, x: 44, y: 38,  title: "EVENT O", venue: "IT Building" },
    { id: 16, x: 45, y: 33,  title: "EVENT P", venue: "IT Building" },
    { id: 17, x: 35, y: 26,  title: "EVENT Q", venue: "IT Building" },
    { id: 18, x: 18, y: 22,  title: "EVENT R", venue: "IT Building" },
    { id: 19, x: 15, y: 12,  title: "EVENT S", venue: "IT Building" },
    { id: 20, x: 14, y: 5,   title: "EVENT T", venue: "IT Building" },
  ];
  ...
  const horizontalLocs = [
    ...
    { id: 13, x: 94,  y: 74, title: "EVENT M", venue: "IT Building" },
    { id: 14, x: 105, y: 77, title: "EVENT N", venue: "IT Building" },
    { id: 15, x: 118, y: 78, title: "EVENT O", venue: "IT Building" },
    { id: 16, x: 128, y: 78, title: "EVENT P", venue: "IT Building" },
    { id: 17, x: 142, y: 75, title: "EVENT Q", venue: "IT Building" },
    { id: 18, x: 155, y: 67, title: "EVENT R", venue: "IT Building" },
    { id: 19, x: 166, y: 60, title: "EVENT S", venue: "IT Building" },
    { id: 20, x: 175, y: 55, title: "EVENT T", venue: "IT Building" },
  ];
