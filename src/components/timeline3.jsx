...
const Timeline3 = () => {
  ...
  const verticalLocs = [
    ...
    { id: 12, x: 35, y: 52,  title: "EVENT M", venue: "IT Building" },
    { id: 13, x: 39, y: 43,  title: "EVENT N", venue: "IT Building" },
    { id: 14, x: 45, y: 33,  title: "EVENT O", venue: "IT Building" },
    { id: 15, x: 35, y: 26,  title: "EVENT P", venue: "IT Building" },
    { id: 16, x: 18, y: 22,  title: "EVENT Q", venue: "IT Building" },
    { id: 17, x: 15, y: 12,  title: "EVENT R", venue: "IT Building" },
  ];
  ...
  const horizontalLocs = [
    ...
    { id: 12, x: 94,  y: 74, title: "EVENT M", venue: "IT Building" },
    { id: 13, x: 115, y: 78, title: "EVENT O", venue: "IT Building" },
    { id: 14, x: 128, y: 78, title: "EVENT P", venue: "IT Building" },
    { id: 15, x: 142, y: 75, title: "EVENT Q", venue: "IT Building" },
    { id: 16, x: 155, y: 67, title: "EVENT R", venue: "IT Building" },
    { id: 17, x: 166, y: 60, title: "EVENT S", venue: "IT Building" },
  ];
