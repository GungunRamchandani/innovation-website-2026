...
const Timeline = () => {
  ...
  const verticalLocs = [
  { id: 1,  x: 85, y: 140, title: "Valedictory", venue: "TBD" },
  ...
  { id: 4,  x: 65, y: 125, title: "Zero UI Challenge", venue: "5th floor main building" },
  { id: 5,  x: 42, y: 122, title: "AR Game", venue: "Main Building 1st floor" },
  { id: 6,  x: 55, y: 125, title: "CTF", venue: "Main Building 5th floor, 3 labs" },
  { id: 7,  x: 32, y: 110, title: "Project Exhibition", venue: "Between IT and Main Building" },
  { id: 8,  x: 32, y: 98,  title: "Saksham Hackathon", venue: "Main Building 2nd floor classrooms" },
  { id: 9,  x: 40, y: 92,  title: "Research Competition", venue: "Main Building 2nd floor- 1 classroom" },
  { id: 10, x: 52, y: 83,  title: "Structural Showdown", venue: "5th floor mech or Danfoss lab" },
  { id: 11, x: 56, y: 78,  title: "Escape Room", venue: "Mech 2nd floor" },
  { id: 12, x: 57, y: 71,  title: "Mozilla Event", venue: "Instru green space" },
  { id: 13, x: 44, y: 64,  title: "Hardware Hackathon", venue: "Any 2 labs from main building 4th floor" },
  { id: 14, x: 35, y: 52,  title: "Botsprint", venue: "Instru Quad" },
  { id: 15, x: 39, y: 43,  title: "Ideation", venue: "Main Quad" },
  { id: 16, x: 45, y: 33,  title: "Trailblazers", venue: "Mechanical Circle" },
  { id: 17, x: 35, y: 26,  title: "The Algorithm Human Bot", venue: "Tutorial room IT building Ground floor" },
  { id: 18, x: 18, y: 22,  title: "Esports", venue: "BGMI - Instru quad" },
  { id: 19, x: 15, y: 12,  title: "Math on Spot", venue: "Near Canteen" },
];

  // Horizontal Coordinates (Custom plotted for your horizontal image path)
  const horizontalLocs = [
  { id: 1,  x: 5,   y: 46, title: "Valedictory", venue: "TBD" },
  { id: 2,  x: 15,  y: 50, title: "Software Hackathon", venue: "Mech building classrooms" },
  { id: 3,  x: 16,  y: 59, title: "ML Bootcamp", venue: "mech auditorium" },
  { id: 4,  x: 25,  y: 66, title: "Zero UI Challenge", venue: "5th floor main building" },
  { id: 5,  x: 35,  y: 67, title: "AR Game", venue: "Main Building 1st floor" },
