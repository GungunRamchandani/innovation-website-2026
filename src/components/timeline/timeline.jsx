...
const Timeline = () => {
 ...
 const verticalLocs = [
  { id: 1,  x: 85, y: 137, title: "Inauguration",            venue: "Main Quadrangle" },
  { id: 3,  x: 88, y: 132, title: "Software Hackathon",      venue: "Mech building classrooms" },
  ...
  { id: 12, x: 55, y: 125, title: "AR Game",                 venue: "Main Building 1st floor" },
  { id: 13, x: 42, y: 122, title: "No Code Hackathon",       venue: "TBD" },
  { id: 15, x: 35, y: 118, title: "Project Exhibition",      venue: "Between IT and Main Building" },
  { id: 16, x: 32, y: 110, title: "Saksham Hackathon",       venue: "Main Building 2nd floor classrooms" },
  { id: 17, x: 32, y: 100, title: "Datathon (Datasprint)",   venue: "Inauguration: KB Joshi auditorium" },
  { id: 19, x: 40, y: 92,  title: "Structural Showdown",     venue: "Day 1: 5th floor mech or Danfoss lab 1st floor" },
  { id: 20, x: 52, y: 83,  title: "Analysis Workshop",       venue: "Cerie Lab" },
  { id: 21, x: 56, y: 78,  title: "Escape Room",             venue: "Mech 2nd floor" },
  { id: 22, x: 57, y: 71,  title: "Mozilla Event",           venue: "Instru green space" },
  { id: 23, x: 44, y: 64,  title: "Arduino Workshop (AW)",   venue: "Main building 3rd floor Lab" },
  ...
  { id: 28, x: 44, y: 38,  title: "Trailblazers",            venue: "Mechanical Circle" },
  { id: 29, x: 45, y: 33,  title: "Business",                venue: "KB Joshi" },
  { id: 30, x: 35, y: 26,  title: "The Algorithm Human Bot", venue: "Tutorial room IT building Ground floor" },
  { id: 31, x: 15, y: 5,   title: "Esports",                 venue: "Stumble guys - placement cell lab; BGMI - Instru quad" },
  { id: 32, x: 25, y: 25,  title: "ImpEx",                   venue: "Discussion Room - Main building 3rd floor" },
  { id: 33, x: 18, y: 22,  title: "Math on Spot",            venue: "Near Canteen" },
];

  // Horizontal Coordinates
  const horizontalLocs = [
  { id: 1,  x: 5,   y: 46, title: "Inauguration",            venue: "Main Quadrangle" },
  { id: 3,  x: 15,  y: 50, title: "Software Hackathon",      venue: "Mech building classrooms" },
  { id: 5,  x: 16,  y: 55, title: "ML Bootcamp",             venue: "mech auditorium" },
  { id: 6,  x: 15,  y: 59, title: "Open Source Competition",  venue: "main building classroom" },
  { id: 12, x: 25,  y: 63, title: "AR Game",                 venue: "Main Building 1st floor" },
  { id: 13, x: 35,  y: 67, title: "No Code Hackathon",       venue: "TBD" },
  { id: 15, x: 48,  y: 63, title: "Project Exhibition",      venue: "Between IT and Main Building" },
  { id: 16, x: 60,  y: 56, title: "Saksham Hackathon",       venue: "Main Building 2nd floor classrooms" },
  { id: 17, x: 68,  y: 50, title: "Datathon (Datasprint)",   venue: "Inauguration: KB Joshi auditorium" },
  { id: 19, x: 65,  y: 41, title: "Structural Showdown",     venue: "Day 1: 5th floor mech or Danfoss lab 1st floor" },
  { id: 20, x: 75,  y: 39, title: "Analysis Workshop",       venue: "Cerie Lab" },
  { id: 21, x: 85,  y: 42, title: "Escape Room",             venue: "Mech 2nd floor" },
  { id: 22, x: 89,  y: 52, title: "Mozilla Event",           venue: "Instru green space" },
  { id: 23, x: 87,  y: 62, title: "Arduino Workshop (AW)",   venue: "Main building 3rd floor Lab" },
  ...
  { id: 28, x: 118, y: 78, title: "Trailblazers",            venue: "Mechanical Circle" },
  { id: 29, x: 128, y: 76, title: "Business",                venue: "KB Joshi" },
  { id: 30, x: 142, y: 74, title: "Algorithm Human Bot",     venue: "Tutorial room IT building Ground floor" },
  { id: 31, x: 155, y: 67, title: "Esports",                 venue: "Stumble guys - placement cell lab; BGMI - Instru quad" },
  { id: 32, x: 155, y: 67, title: "ImpEx",                   venue: "Discussion Room - Main building 3rd floor" },
