...
const Timeline = () => {
  ...
  const horizontalLocs = [
    ...
    { id: 5,  x: 25,  y: 63, title: "AR Game",                   venue: "Main Building 1st floor" },
    ...
    { id: 8,  x: 60,  y: 56, title: "Saksham Hackathon",         venue: "Main Building 2nd floor classrooms" },
    ...
    { id: 19, x: 128, y: 76, title: "Business",                  venue: "KB Joshi" },
    { id: 20, x: 142, y: 74, title: "Algorithm Human Bot",   venue: "Tutorial room IT building Ground floor" },
